...
export interface VehicleDef {
  ...
  price: number;
  /** Peut tracter une remorque attelée (voir World.attachTrailer). */
  canTow?: boolean;
}
...
export const VEHICLE_CATALOG: VehicleDef[] = [
  ...
  { id: "tracteur-ferme", kind: "tracteur", label: "Tracteur", color: 0x8fbf4a, home: "ferme", price: 5000, canTow: true },
  { id: "camion-benne", kind: "camion", label: "Camion benne", color: 0xe2761b, home: "chantier", price: 8000, canTow: true },
  { id: "camion-plateau", kind: "camion", label: "Camion plateau", color: 0x2a3345, home: "ville", price: 8000, canTow: true },
